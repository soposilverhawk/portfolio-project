...
const developerData = {
  aboutText: {
    ...
    ru: "Мне 24 года, я начинающий front-end разработчик, увлечённый созданием интуитивных и удобных веб-интерфейсов. Я начал(а) свой путь в разработке с самостоятельного обучения. Благодаря своей целеустремлённости я попал(а) в программу по веб-разработке, спонсируемую ООН и BTU, где успешно завершил(а) направление по front-end разработке (HTML, CSS, JavaScript, React, Next.js). В настоящее время я ищу возможность получить практический опыт и наставничество в рамках реальных проектов",
  },
  education: {
    en: [
      {
